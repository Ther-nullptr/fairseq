...
@dataclass
class Data2VecSiameseConfig(Wav2Vec2Config):
...
@register_model("data2vec_siamese", dataclass=Data2VecSiameseConfig)
class Data2VecSiameseModel(BaseFairseqModel):
    def __init__(self, cfg: Data2VecSiameseConfig):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: Data2VecSiameseConfig, task=None):
    ...
    def forward(
        ...
        x = self.final_proj(x) # [1,413,768]=>[1,413,768] # TODO is this useful?
        ...
        cos_similarity = self.compute_preds(x, y, negs) # [101,1,413] #! y is positive(1), negs is negetive(100)
        ...
        loss = F.cross_entropy(logits, target, reduction=reduction) # TODO: is this same as loss of wav2vec2 
